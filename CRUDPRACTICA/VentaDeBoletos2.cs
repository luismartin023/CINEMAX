...
{
    public partial class VentaDeBoletos2 : Form
    {
        public Cartelera FormPrincipal { get; set; }
        public VentaDeBoletos2()
        {
            InitializeComponent();
        ...
        private void Btn_Confirmar3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                entrada.Tipo = cmb_entrada3.Text;
        ...
        private void VentaDeBoletos2_Load(object sender, EventArgs e)
        {
